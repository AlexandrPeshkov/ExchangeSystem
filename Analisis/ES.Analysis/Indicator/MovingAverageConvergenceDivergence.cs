...
namespace ES.Analysis.Indicator
{
    ...
    public class MovingAverageConvergenceDivergence : MovingAverageConvergenceDivergence<IOhlcv, Analysis<(decimal? MacdLine, decimal? SignalLine, decimal? MacdHistogram)>>
    {
