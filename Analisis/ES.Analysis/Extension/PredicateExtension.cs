...
using AnTick = ES.Analysis.Analysis<decimal?>;
using AnTp2Tick = ES.Analysis.Analysis<(decimal?, decimal?)>;
using AnTp3Tick = ES.Analysis.Analysis<(decimal?, decimal?, decimal?)>;
