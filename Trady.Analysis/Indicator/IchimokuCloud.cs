...
namespace ES.Analysis.Indicator
{
    ...
    public class IchimokuCloud : IchimokuCloud<IOhlcv, Analysis<(decimal? ConversionLine, decimal? BaseLine, decimal? LeadingSpanA, decimal? LeadingSpanB, decimal? LaggingSpan)>>
    {
